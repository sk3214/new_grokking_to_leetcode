...
## Sliding Window
- [X] [Find Maximum in Sliding Window](https://leetcode.com/problems/sliding-window-maximum/) - Couldn't think of an optimal approach in time

- [X] [Minimum Window Subsequence](https://leetcode.com/problems/minimum-window-substring/) - Couldn't come up with the solution

- [X] [Repeated DNA Sequences](https://leetcode.com/problems/repeated-dna-sequences/)

- [X] [Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) - Some silly mistake
...
- [X] [Sum of Three Values](https://leetcode.com/problems/3sum-closest/) - Couldn't solve it in first attempt

- [X] [Reverse Words in a String](https://leetcode.com/problems/reverse-words-in-a-string/) - Could have made it cleaner

- [X] [Valid Palindrome II](https://leetcode.com/problems/valid-palindrome-ii/) _ Nahi Aaya (Should have been easy)
...
- [ ] [Circular Array Loop](https://leetcode.com/problems/circular-array-loop/) - Couldn't solve it
...
- [X] [Interval List Intersections](https://leetcode.com/problems/interval-list-intersections/) - Took a lot of time but good thinking!
...
- [X] [Maximize Capital](https://leetcode.com/problems/ipo/) - Needed help to solve it completely

- [ ] [Sliding Window Median](https://leetcode.com/problems/sliding-window-median/) - couldn't solve it
...
- [ ] [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) - couldn't solve it in 1 go
